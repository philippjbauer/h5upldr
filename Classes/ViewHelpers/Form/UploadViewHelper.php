<?php
namespace Bureauoberhoff\H5upldr\ViewHelpers\Form;
...
class UploadViewHelper extends \TYPO3\CMS\Fluid\ViewHelpers\Form\UploadViewHelper {
	...
	public function render() {
		...
		if ($resource !== NULL) {
			...
			$output .= '<div class="ajaxupload-resourcedata" data-filename="' . $resource->getOriginalResource()->getOriginalFile()->getName() . '"></div>';
